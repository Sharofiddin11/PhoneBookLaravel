  ...
  <div class="container">
    ...
    <form action="<?php echo e(route('people.update', $peodata->id)); ?>" method="post">
      ...
      <div class="row">
        ...
        <br>
        <div class="col-md-12">
          <a href="<?php echo e(route('people.index')); ?>" class="btn btn-sm btn-success">Back</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\OpenServer\OSPanel\domains\phonebook3\resources\views/peopledate/edit.blade.php ENDPATH**/ ?>